...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{itemize}
      ...
      \item p-value: 0.005 (highly significant)
...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \textbf{NO INVERTED-U PATTERN OBSERVED}
    
    \vspace{0.3em}
    \begin{itemize}
      \setlength{\itemsep}{0.3em}
      \item Flat relationship: Contract CNA use unchanged by facility size
      \item Linear term: $\beta = -0.000050$ (p = 0.393, not significant)
      \item Quadratic term: $\beta = +0.0000003$ (p = 0.286, not significant)
      \item Pattern: Contract CNA approximately 5--6\% across all deciles
      \item Implication: Facility size does NOT determine contract labor strategy
    \end{itemize}
    ...
    \begin{figure}
      ...
      \caption{\small Contract CNA vs. Facility Size. Flat pattern across all sizes}
    \end{figure}
  \end{columns}
\end{frame}
